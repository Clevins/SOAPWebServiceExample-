...
INSERT INTO `book` (`book_id`, `title`, `image`, `description`, `category`, `ISBN`, `author`, `year`) VALUES
(1, 'Universal Design: Creating Inclusive Environments', 'upd.jpg', 'Written by top thinkers at the Center for Inclusive Design and Environmental Access (IDeA), it demonstrates the difference between universal design and accessibility and identifies its relationship to sustainable design and active living. ', 'Design', '978-0-470-39913-2', 'Edward Steinfeld, Jordana Maisel', '2012-06-12'),
(2, 'Professional C++, 4th Edition', 'c++.jpg', 'Professional C++ is the advanced manual for C++ programming. Designed to help experienced developers get more out of the latest release, this book skims over the basics and dives right in to exploiting the full capabilities of C++17. ', 'Computing', '978-1-119-42122-1', 'Marc Gregoire', '2005-08-02'),
(3, 'Engineering: An Illustrated History from Ancient Craft to Modern Technology (100 Ponderables)', 'engineering.jpg', 'Combining engaging text with captivating images and helpful diagrams, renowned science writer Tom Jackson guides readers through the history of Engineering in the 7th installment of the groundbreaking PonderablesTM series.', 'Engineering', '0985323094', 'Tom Jackson ', '2018-10-28'),
(4, 'Fundamental Accounting Principles', 'accountingPrinciples.jpg', 'Enhancements in technology have changed how we live and learn. Working with learning resources across devices, whether smartphones, tablets, or laptop computers, empowers students to drive their own learning by putting increasingly intelligent technology into their hands. Whether the goal is to become an accountant, a businessperson, or simply an informed consumer of accounting information, Fundamental Accounting Principles has helped generations of students succeed.', 'Accounts', '978-0077862275', 'Kevin Shaw', '1999-04-11'),
(5, 'College physics', 'physics.jpg', 'This introductory, algebra-based, two-semester college physics book is grounded with real-world examples, illustrations, and explanations to help students grasp key, fundamental physics concepts. College Physics includes learning objectives, concept questions, links to labs and simulations, and ample practice opportunities to solve traditional physics application problems. This book is available for free online by searching for OpenStax College Physics', 'Science', '978-1938168000', 'Paul Peter Urone', '2010-02-20'),
(6, 'Music', 'musicBook.jpg', 'Music: An Appreciation remains the time-tested solution for welcoming non-majors to the art of listening to great music. Now, Roger Kamien places a renewed focus on learning the elements of music, fostering each students unique path to listening and understanding', 'Music', '978-1259870545', ' Roger Kamien', '2007-11-15'),
(7, 'Braunwald\'s Heart Disease: A Textbook of Cardiovascular Medicine', 'heartDisease.jpg', 'Trusted by generations of cardiologists for the latest, most reliable guidance in the field, Braunwalds Heart Disease, 11th Edition, remains your #1 source of information on rapidly changing clinical science, clinical and translational research, and evidence-based medicine. ', 'nursing', ' 978-0323463423', 'Douglas P. Zipes MD', '2016-12-12'),
(8, 'Java for beginners', 'java.jpg', 'Java is an object orientated programming language. This book will teach you the basics of the language and the basic concepts of oo programming.  ', 'Computing', '51181818918918', 'Bill Conway', '2012-12-03');
